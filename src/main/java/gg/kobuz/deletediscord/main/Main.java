...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		parser.accepts("demo");
		OptionSpec<String> fileDirSpec = parser.accepts("dir").withRequiredArg();
        ...
        File file = new File(fileDirSpec.value(optionset));
        ...
        Logger.info(fileDirSpec.value(optionset));
        Configuration config = new Configuration(new File(fileDirSpec.value(optionset), "config.properties"));
